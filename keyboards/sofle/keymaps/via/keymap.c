...
const uint16_t PROGMEM right_brace[] = {KC_F, KC_G, COMBO_END};
const uint16_t PROGMEM left_bracket[] = {KC_C, KC_V, COMBO_END};
const uint16_t PROGMEM right_bracket[] = {KC_V, KC_B, COMBO_END};
 ...
 */
[_Nav] = LAYOUT(
  _______, A(KC_TAB) , KC_WDESK_L, KC_WTAB,  KC_WDESK_R , KC_WNEWDESK,                                                     KC_WNEWDESK,KC_WDESK_L, KC_WTAB,  KC_WDESK_R,  KC_WDELDESK ,A(KC_F4),
  ...
  C(KC_Y), C(KC_A),  QK_MOUSE_CURSOR_LEFT,  QK_MOUSE_CURSOR_DOWN,  QK_MOUSE_CURSOR_RIGHT, MS_WHLD,                  KC_PGDN,  KC_LEFT, KC_DOWN, KC_RGHT,  KC_DEL, KC_BSPC,
